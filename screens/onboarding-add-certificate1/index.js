...
const OnboardingAddCertificateScreen = params => {
  return <View style={styles.container}>
      ...
      <View style={styles.chooseContainer}>
        ...
        <Image source={require( // @ts-ignore
      "./assets/upload.png")} style={styles.chooseImg} />
      </View>
